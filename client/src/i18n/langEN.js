export default {
  ...
  home: {
    'page-title': 'Genuine billiards and accessories | Huu Nghia Billiards',
    cart: 'Cart',
  ...
  account: {
    'page-title': 'Account | Huu Nghia Billiards',
    info: 'Info',
    order: 'Order',
  ...
  cart: {
    'page-title': 'Shopping cart | Huu Nghia Billiards',
    title: 'Cart',
  ...
  order: {
    'page-title': 'Orders | Huu Nghia Billiards',
    'dashboard-page-title': 'Order Management | Huu Nghia Billiards',
    heading: 'Order List',
    title: 'Order',
  ...
  auth: {
    'page-title': {
      login: 'Log in | Huu Nghia Billiards',
      register: 'Register | Huu Nghia Billiards',
      'reset-password': 'Reset password | Huu Nghia Billiards'
    },
    ...
    'accept-terms': 'By registering, I agree to Huu Nghia Billiards',
    tos: 'Terms of Service',
    'privacy-policy': 'Privacy Policy',

    'register-salutation': 'Hi, Welcome to Huu Nghia Billiards',
  ...
  dashboard: {
    ...
    categories: {
      'page-title': 'Category management | Huu Nghia Billiards',
    ...
    brands: {
      'page-title': 'Brand management | Huu Nghia Billiards',
      title: 'Brands',
    ...
    discounts: {
      'page-title': 'Discount management | Huu Nghia Billiards',
      title: 'Discounts',
    ...
    users: {
      'page-title': 'User management | Huu Nghia Billiards',
      title: 'Users',
      heading: 'User List',
  ...
  products: {
    'page-title': 'Product management | Huu Nghia Billiards',
    title: 'Products',
    list: 'Product list',
    ...
    save: 'Save Changes',
    'add-title': 'Ecommerce: Add new product | Huu Nghia Billiards',
    'add-success': 'Successfully added product.',
    edit: 'Edit product',
    'edit-title': 'Ecommerce: Edit new product | Huu Nghia Billiards',
    ...
    'infor-1-content': 'All products at Huu Nghia Billiards are genuine in Vietnam',
