...
export default {
  ...
  products: {
    ...
    name: 'Tên sản phẩm',
    'name-validation': 'Tên sản phẩm không được để trống',
    desc: 'Mô tả sản phẩm',
    'desc-validation': 'Mô tả không được để trống',
    price: 'Giá',
    'price-validation': 'Vui lòng nhập giá tiền',
    'market-price': 'Giá thị trường',
    'market-price-validation': 'Vui lòng nhập giá thị trường',
    sku: 'Mã phiên bản (không trùng với các phiên bản trước đó)',
    'sku-validation': 'Mã phiên bản không được để trống',
    variant: 'Phiên bản',
    quantity: 'Số lượng',
